...
const Dialog = () => {
  return (
    <div className="hidden md:static absolute top-[70%] right-[50%] lg:bottom-initial xl:top-[218px] lg:top-96 xl:right-[485px] lg:right-72 w-[292px] p-[20px] rounded-[10px] shadow-[0_15px_30px_0_rgba(0,0,0,0.1)] bg-white">
